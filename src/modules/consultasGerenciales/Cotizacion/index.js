...
import ConsultaCotizacionCreador from './../../cotizaciones/ConsultaCotizacion/ConsultaCotizacionCreador';
import ConsultaCotizacionProductoCreador from './../../cotizaciones/ConsultaCotizacion/ConsultaCotizacionProductoCreador';
            ...
            {({values, handleReset, isValid, resetForm}) => (
              <Form noValidate>
                <Box className={classes.contenedorFiltros}>
                  <MyTextField
                    label='Fecha Cotizacion Inicial'
                ...
                <Box className={classes.contenedorFiltros}>
                  <MyRadioField
                    ...
                    name='tipoCotizacionFiltro'
                    required
                    options={[
                      {value: 'S', label: 'Servicios'},
                      {value: 'P', label: 'Productos Sellos'},
                    ]}
                  />
                </Box>
              </Form>
...
EnhancedTableToolbar.propTypes = {
  ...
  tipoCotizacionFiltro: PropTypes.string.isRequired,
};
...
const CotizacionConsulta = (props) => {
  ...
  const datosTabla = useSelector(
    ({cGCotizacionReducer}) => cGCotizacionReducer.ligera,
  );
  ...
  const [tipoCotizacionFiltro, setTipoCotizacionFiltro] = useState('');
  ...
  }, [dispatch, fechaInicialFiltro, fechaFinalFiltro, tipoCotizacionFiltro]);
  ...
  const queryFilter = (e) => {
    switch (e.target.name) {
      ...
      case 'fechaInicialFiltro':
        ...
        break;
      case 'tipoCotizacionFiltro':
        setTipoCotizacionFiltro(e.target.value);
        break;
      case 'estadoFiltro':
  ...
  const validationSchema = yup.object().shape(
    {
      ...
      tipoCotizacionFiltro: yup.string().required('Requerido'),
    },
  ...
  const getValues = (value) => {
    ...
    setTipoCotizacionFiltro(value.tipoCotizacionFiltro);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            tipoCotizacionFiltro={tipoCotizacionFiltro}
      ...
      {showForm && tipoCotizacionFiltro === 'S' ? (
...
export default CotizacionConsulta;
