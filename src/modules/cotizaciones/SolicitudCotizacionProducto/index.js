          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Box component='a' href='/solicitud-cotizacion-productos/crear'>
                  <Tooltip title='Crear Solicitud Cotización'>
                    <IconButton
...
const SolicitudCotizacionProducto = (props) => {
  ...
  const onDeleteSolicitudCotizacionProducto = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro que dese anular la solicitud cotización producto?',
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire(
          'Anulado',
          'La solicitud cotización producto fue anulada correctamente',
          'success',
        );
      }
    });
                          ...
                          <TableCell
                            ...
                            {permisos.indexOf('Modificar') >= 0 && (
                              <Box
                                component='a'
                                href={
                                  '/solicitud-cotizacion-productos/editar/' +
                                  row.id
                                }
                            ...
                            {permisos.indexOf('Listar') >= 0 && (
                              <Box
                                component='a'
                                href={
                                  '/solicitud-cotizacion-productos/ver/' +
                                  row.id
                                }
                                className={classes.generalIcons}>
                                <Tooltip
                            ...
                            {permisos.indexOf('Eliminar') >= 0 && (
                              <Tooltip title={'Anular'}>
                                <DeleteIcon
                                  onClick={() =>
                                    onDeleteSolicitudCotizacionProducto(row.id)
                                  }
...
export default SolicitudCotizacionProducto;
