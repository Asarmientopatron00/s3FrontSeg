...
const cells = [
  ...
  },
  {
    ...
    label: 'Estado',
    value: (value) =>
      ESTADO_PEDIDOS.map((tipo) => (tipo.id === value ? tipo.nombre : '')),
    align: 'left',
    mostrarInicio: true,
  },
  {
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Box component='a' href='/pedido/crear'>
...
const Pedido = (props) => {
  ...
  const onDeletePedido = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro que dese anular el pedido?',
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire('Anulado', 'El pedido fue anulado correctamente', 'success');
      }
    });
  };
                        ...
                        />
                          ...
                          <TableCell
                            ...
                            {permisos.indexOf('Listar') >= 0 && (
                              <Box component='a' href={'/pedido/ver/' + row.id}>
                                <Tooltip
