...
import DetalleCotizacionProductoCreador from './DetalleCotizacionProductoCreador';
...
const EnhancedTableToolbar = (props) => {
  ...
  const {
    ...
    onOpenAddDetalleCotizacionProducto,
  } = props;
  return (
    <Toolbar>
      {numSelected > 0 ? (
...
const Cotizacion = (props) => {
  ...
  const [
    ...
    setDetalleCotizacionProductoSeleccionado,
  ] = useState(0);
  ...
  const onOpenEditDetalleCotizacionProducto = (id) => {
    setDetalleCotizacionProductoSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };

  const onOpenAddDetalleCotizacionProducto = () => {
    setDetalleCotizacionProductoSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };

  const onOpenViewDetalleCotizacionProducto = (id) => {
    setDetalleCotizacionProductoSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };
  ...
  return (
    <Box className={classes.marcoTabla}>
                      ...
                      />
                            ...
                            <TableCell
                              ...
                              <Tooltip
                                ...
                                onClick={() =>
                                  onOpenEditDetalleCotizacionProducto(row.id)
                                }>
                                <EditIcon
                              ...
                              <Tooltip title={<IntlMessages id='boton.ver' />}>
                                <VisibilityIcon
                                  ...
                                  onClick={() =>
                                    onOpenViewDetalleCotizacionProducto(row.id)
                                  }
                                />
                              </Tooltip>
                              {/* )} */}
      ...
      {showForm ? (
        <DetalleCotizacionProductoCreador
          showForm={showForm}
          detalleCotizacion={detalleCotizacionSeleccionado}
          accion={accion}
          handleOnClose={handleOnClose}
          titulo='Detalle Cotización Producto'
          empresa={empresa}
