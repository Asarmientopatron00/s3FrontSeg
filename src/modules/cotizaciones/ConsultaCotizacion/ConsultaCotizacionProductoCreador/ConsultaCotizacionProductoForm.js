...
const ConsultaCotizacionProductoForm = (props) => {
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell className={classes.tableHead}>Color</TableCell>
                    <TableCell className={classes.tableHead}>
                      Valor Unitario
                    </TableCell>
                  </TableRow>
                  ...
                  {rows.map((row) => {
                    return (
                      <TableRow>
                        ...
                        <TableCell className={classes.tableCell}>
                          {row.dimensiones_producto}
                        </TableCell>
                        <TableCell className={classes.tableCell}>
                          {row.color}
                        </TableCell>
                        <TableCell className={classes.tableCell}>
                          {row.valor_unitario_producto}
                        </TableCell>
                      </TableRow>
                    );
                  })}
...
export default ConsultaCotizacionProductoForm;
