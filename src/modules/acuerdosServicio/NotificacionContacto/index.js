...
import NotificacionContactoCreador from './NotificacionContactoCreador';
import {
  onGetColeccion,
  onDelete,
...
import {onGetColeccionLigera} from '../../../redux/actions/EventoNotificacionAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              <Tooltip
                ...
                onClick={onOpenAddNotificacionContacto}>
                <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddNotificacionContacto: PropTypes.func.isRequired,
...
const NotificacionContacto = () => {
  ...
  const [
    notificacionContactoSeleccionado,
    setNotificacionContactoSeleccionado,
  ] = useState(0);
  ...
  const onOpenEditNotificacionContacto = (id) => {
    setNotificacionContactoSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewNotificacionContacto = (id) => {
    setNotificacionContactoSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteNotificacionContacto = (id) => {
    Swal.fire({
      title: 'Confirmar',
  ...
  const onOpenAddNotificacionContacto = () => {
    setNotificacionContactoSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  const eventosNotificaciones = useSelector(
    ({eventoNotificacionReducer}) => eventoNotificacionReducer.ligera,
  );
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar
          ...
          onOpenAddNotificacionContacto={onOpenAddNotificacionContacto}
                        ...
                        />
                          ...
                          <TableCell
                            ...
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() =>
                                  onOpenEditNotificacionContacto(row.id)
                                }
                            ...
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() =>
                                  onOpenViewNotificacionContacto(row.id)
                                }
                            ...
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() =>
                                  onDeleteNotificacionContacto(row.id)
                                }
      ...
      /> */}
      {showForm ? (
        <NotificacionContactoCreador
          showForm={showForm}
          notificacionContacto={notificacionContactoSeleccionado}
          accion={accion}
