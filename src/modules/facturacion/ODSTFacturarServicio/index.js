                  ...
                  {permisos.indexOf('Exportar') >= 0 && (
                    <Tooltip
                      ...
                      href={
                        ...
                        '/facturacion/os-ter-facturar-servicio' +
                        '?fechaInicial=' +
                        fechaInicialFiltro +
                        '&fechaFinal=' +
                        fechaFinalFiltro
...
const ODSTFacturarServicio = (props) => {
  ...
  const [
    oDSTFacturarServicioSeleccionado,
    setODSTFacturarServicioSeleccionado,
  ] = useState(0);
  ...
  useEffect(() => {
    setPage(1);
  }, [orderByToSend, fechaFinalFiltro, fechaInicialFiltro]);
  ...
  const onOpenViewConsultaCotizacion = (id) => {
    setODSTFacturarServicioSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };
  ...
  const handleOnClose = () => {
    setShowForm(false);
    setODSTFacturarServicioSeleccionado(0);
    setAccion('ver');
  };
