...
import {onImportAFacturar} from '../../../redux/actions/OrdenServicioAction';
...
const OrdenServicioAFacturarDocumento = () => {
          ...
          <Box className={classes.marcoTabla}>
            ...
            <Formik
              ...
              onSubmit={(data, {setSubmitting, resetForm}) => {
                setSubmitting(true);
                dispatch(onImportAFacturar(data, setActiveStep, setRows));
                setSubmitting(false);
              }}>
            ...
            <Box display='flex' justifyContent='space-between'>
              ...
              <Box>
                <ExcelFile
                  ...
                  filename={
                    'Resultados Carga ODS Facturadas -' +
                    new Date(Date.now()).getTime()
                  }>
                  <ExcelSheet data={rows.errores} name='Hoja 1'>
                    <ExcelColumn
                      label='Numero Orden de Servicio'
                      value='numero_orden_servicio'
                      widthPx={160}
                    />
                    <ExcelColumn
                      label='Nombre Asociado Negocio'
                      value='asociado_negocio'
                    />
                    <ExcelColumn label='Numero Viaje' value='numero_viaje' />
                    <ExcelColumn
                      label='Numero Factura'
                      value='numero_factura'
                    />
                    <ExcelColumn label='Fecha Factura' value='fecha_factura' />
...
export default OrdenServicioAFacturarDocumento;
