...
import RolCreador from './RolCreador'
import {
  onGetColeccion,
  onDelete,
...
const cells = [
  ...
  {id:'tipo', typeHead: 'string',label: 'Tipo',value:(value)=>TIPOS_ROLES.map((tipoRol)=>tipoRol.id===value?tipoRol.value:""), align:'left',mostrarInicio:true},
...
const Roles =  () => {
  ...
  const {rows,
          ...
          ultima_pagina,
          total,
        } = useSelector(({rolReducer}) => rolReducer);
                    ...
                    > 
                      ...
                      <TableCell align="center" className={classes.acciones}> 
                        <Tooltip title={<IntlMessages id='boton.editar'/>}>
                          <EditIcon onClick={()=>onOpenEditRol(row.id)} className={`${classes.generalIcons} ${classes.editIcon}`}></EditIcon>
                        </Tooltip>
                        <Tooltip title={<IntlMessages id='boton.ver'/>}>
                          <VisibilityIcon onClick={()=>onOpenViewRol(row.id)} className={`${classes.generalIcons} ${classes.visivilityIcon}`}></VisibilityIcon> 
                        </Tooltip>
                        <Tooltip title={<IntlMessages id='boton.eliminar'/>}>
                          <DeleteIcon  onClick={()=>onDeleteRol(row.id)} className={`${classes.generalIcons} ${classes.deleteIcon}`}></DeleteIcon> 
                        </Tooltip>
                      </TableCell>
