            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip
                  ...
                  onClick={onOpenAddTerceroServicio}>
                  <IconButton
...
const TerceroServicio = (props) => {
  ...
  const [terceroServicioSeleccionado, setTerceroServicioSeleccionado] =
    useState(0);
                          ...
                          <TableCell
                            ...
                            {permisos.indexOf('Modificar') >= 0 && (
                              <Tooltip
                                ...
                                <EditIcon
                                  onClick={() =>
                                    onOpenEditTerceroServicio(row.id)
                                  }
                            ...
                            {permisos.indexOf('Listar') >= 0 && (
                              <Tooltip title={<IntlMessages id='boton.ver' />}>
                                <VisibilityIcon
                                  onClick={() =>
                                    onOpenViewTerceroServicio(row.id)
                                  }
                            ...
                            {permisos.indexOf('Eliminar') >= 0 && (
                              <Tooltip
                                ...
                                <DeleteIcon
                                  onClick={() =>
                                    onDeleteTerceroServicio(row.id)
                                  }
