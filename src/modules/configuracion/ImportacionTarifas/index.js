...
import {Box, Button, Icon, MenuItem} from '@material-ui/core';
...
import {onImport} from 'redux/actions/TarifaAction';
...
const columns = [
  ...
  'Otro Tipo Servicio',
  'Numero Dias Viaje',
  'Valor Tarifa Antes IVA',
  'Valor Tarifa Dia Adicional Antes IVA',
];
            ...
            <ExcelFile
              element={
                <Button className={`${classes.btnRoot} ${classes.btnPrymary}`}>
                  <Icon>{'download'}</Icon>
                  Formato Importación Tarifas
                </Button>
              }
              filename={'Formato Importacion Tarifas'}>
                          ...
                          {({getRootProps, getInputProps}) => (
                            <div {...getRootProps({style})}>
                              <input
                                ...
                                onChange={(event) => {
                                  const name =
                                    event.currentTarget.files[0].name.toLowerCase();
                              ...
                              />
                              <p>
                                Arrastra un archivo o haz click para cargarlo
                              </p>
                            </div>
                          )}
                        </Dropzone>
...
export default ImportacionTarifas;
