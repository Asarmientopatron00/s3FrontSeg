...
import ColorCreador from './ColorCreador';
import {onGetColeccion, onDelete} from '../../../redux/actions/ColorAction';
...
const cells = [
  ...
  {
    id: 'color_produccion_id',
    typeHead: 'numeric',
    label: 'Color Producción Id',
    value: (value) => value,
    align: 'right',
    mostrarInicio: true,
  },
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddColor: PropTypes.func.isRequired,
...
const Color = (props) => {
  ...
  const onOpenEditColor = (id) => {
    setColorSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
                          ...
                          <TableCell
                            ...
                            {permisos.indexOf('Modificar') >= 0 && (
                              <Tooltip
                                ...
                                <EditIcon
                                  onClick={() => onOpenEditColor(row.id)}
                            ...
                            {permisos.indexOf('Listar') >= 0 && (
                              <Tooltip title={<IntlMessages id='boton.ver' />}>
                                <VisibilityIcon
                                  onClick={() => onOpenViewColor(row.id)}
