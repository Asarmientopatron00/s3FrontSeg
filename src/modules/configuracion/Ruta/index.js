...
import RutaCreador from './RutaCreador';
import {onGetColeccion, onDelete} from '../../../redux/actions/RutaAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Ruta' onClick={onOpenAddRuta}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddRuta: PropTypes.func.isRequired,
...
const Ruta = (props) => {
  ...
  const [rutaSeleccionado, setRutaSeleccionado] = useState(0);
  ...
  const onOpenEditRuta = (id) => {
    setRutaSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewRuta = (id) => {
    setRutaSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteRuta = (id) => {
    Swal.fire({
      title: 'Confirmar',
