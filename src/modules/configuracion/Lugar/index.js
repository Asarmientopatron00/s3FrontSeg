...
import {onGetColeccion, onDelete} from '../../../redux/actions/LugarAction';
...
const cells = [
  ...
  {
    id: 'lugar_asociado_negocios',
    typeHead: 'string',
    label: 'Lugar Propio Asociado',
    value: (value) => (value === 'S' ? 'Si' : 'N'),
    align: 'left',
    mostrarInicio: false,
  },
  {
  ...
  {
    id: 'lugar_aduana_general',
    typeHead: 'string',
    label: 'Lugar Aduana General',
    value: (value) => (value === 'S' ? 'Si' : 'N'),
    align: 'left',
    mostrarInicio: false,
  },
  ...
  const onDeleteLugar = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire(
          'Eliminado',
          'El Lugar Fue Eliminado Correctamente',
          'success',
        );
        updateColeccion();
      }
