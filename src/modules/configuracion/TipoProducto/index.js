...
import TipoProductoCreador from './TipoProductoCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoProductoAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip
                  title='Crear Tipo Producto'
                  onClick={onOpenAddTipoProducto}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoProducto: PropTypes.func.isRequired,
...
const TipoProducto = (props) => {
  ...
  const onOpenEditTipoProducto = (id) => {
  ...
  const onOpenViewTipoProducto = (id) => {
    setTipoProductoSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteTipoProducto = (id) => {
    Swal.fire({
      title: 'Confirmar',
  ...
  const onOpenAddTipoProducto = () => {
    setTipoProductoSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
      ...
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoProducto={onOpenAddTipoProducto}
                          ...
                          <TableCell
                            ...
                            {permisos.indexOf('Modificar') >= 0 && (
                              <Tooltip
                                ...
                                <EditIcon
                                  onClick={() => onOpenEditTipoProducto(row.id)}
                            ...
                            {permisos.indexOf('Listar') >= 0 && (
                              <Tooltip title={<IntlMessages id='boton.ver' />}>
                                <VisibilityIcon
                                  onClick={() => onOpenViewTipoProducto(row.id)}
                            ...
                            {permisos.indexOf('Eliminar') >= 0 && (
                              <Tooltip
                                ...
                                <DeleteIcon
                                  onClick={() => onDeleteTipoProducto(row.id)}
