...
import AsociadoContactoLegalCreador from './AsociadoContactoLegalCreador';
import {
  onGetColeccion,
  onDelete,
...
const cells = [
  ...
  },
  {
    ...
    label: 'Tipo',
    value: (value) =>
      value === 'S' ? 'Socio' : value === 'R' ? 'Representante Legal' : '',
    align: 'left',
    mostrarInicio: true,
  },
  {
...
const EnhancedTableToolbar = (props) => {
  ...
  const {
    numSelected,
    onOpenAddAsociadoContactoLegal,
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              <Tooltip
                ...
                onClick={onOpenAddAsociadoContactoLegal}>
                <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddAsociadoContactoLegal: PropTypes.func.isRequired,
...
const AsociadoContactoLegal = () => {
  ...
  const [
    asociadoContactoLegalSeleccionado,
    setAsociadoContactoLegalSeleccionado,
  ] = useState(0);
  ...
  const onOpenEditAsociadoContactoLegal = (id) => {
    setAsociadoContactoLegalSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewAsociadoContactoLegal = (id) => {
    setAsociadoContactoLegalSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteAsociadoContactoLegal = (id) => {
    Swal.fire({
      title: 'Confirmar',
  ...
  const onOpenAddAsociadoContactoLegal = () => {
    setAsociadoContactoLegalSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar
          ...
          onOpenAddAsociadoContactoLegal={onOpenAddAsociadoContactoLegal}
                        ...
                        />
                          ...
                          <TableCell
                            ...
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() =>
                                  onOpenEditAsociadoContactoLegal(row.id)
                                }
                            ...
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() =>
                                  onOpenViewAsociadoContactoLegal(row.id)
                                }
                            ...
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() =>
                                  onDeleteAsociadoContactoLegal(row.id)
                                }
              ...
              <FormControl>
                <Box display='flex' alignItems='center' style={{gap: '20px'}}>
                  ...
                  <RadioGroup
                    row
                    defaultValue={
                      encabezado.informacion_verificada_legal === 'S'
                        ? 'S'
                        : encabezado.informacion_verificada_legal === 'N'
                        ? 'N'
                        : ''
                    }
                    onClick={(event) => {
                        ...
                        if (
                          ...
                          dispatch(
                            onVerificarInformacion({
                              id: asociado_id,
                              tipo_informacion: 'informacion_verificada_legal',
                              valor: 'S',
                              verificar: true,
                            }),
                          );
      ...
      /> */}
      {showForm ? (
        <AsociadoContactoLegalCreador
          showForm={showForm}
          asociadoContactoLegal={asociadoContactoLegalSeleccionado}
          accion={accion}
...
export default AsociadoContactoLegal;
