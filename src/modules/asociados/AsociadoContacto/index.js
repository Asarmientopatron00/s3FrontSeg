...
import AsociadoContactoCreador from './AsociadoContactoCreador';
import {
  onGetColeccion,
  onDelete,
        ...
        <>
          <Box className={classes.titleTop}>
            <Typography
              ...
              <IntlMessages id='asociados.contactos' />
            </Typography>
            <Box className={classes.horizontalBottoms}>
              ...
              <Tooltip
                ...
                onClick={onOpenAddAsociadoContacto}>
                <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddAsociadoContacto: PropTypes.func.isRequired,
...
const AsociadoContacto = () => {
  ...
  const [asociadoContactoSeleccionado, setAsociadoContactoSeleccionado] =
    useState(0);
  ...
  const onOpenEditAsociadoContacto = (id) => {
    setAsociadoContactoSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewAsociadoContacto = (id) => {
    setAsociadoContactoSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteAsociadoContacto = (id) => {
    Swal.fire({
      title: 'Confirmar',
  ...
  const onOpenAddAsociadoContacto = () => {
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar
          ...
          onOpenAddAsociadoContacto={onOpenAddAsociadoContacto}
                        ...
                        />
                          ...
                          <TableCell
                            ...
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() =>
                                  onOpenEditAsociadoContacto(row.id)
                                }
                            ...
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() =>
                                  onOpenViewAsociadoContacto(row.id)
                                }
                            ...
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() => onDeleteAsociadoContacto(row.id)}
              ...
              <FormControl>
                <Box display='flex' alignItems='center' style={{gap: '20px'}}>
                  ...
                  <RadioGroup
                    row
                    defaultValue={
                      encabezado.informacion_verificada_contactos === 'S'
                        ? 'S'
                        : encabezado.informacion_verificada_contactos === 'N'
                        ? 'N'
                        : ''
                    }
                    onClick={(event) => {
                        ...
                        if (rows.length === 0) {
                          ...
                          dispatch(
                            onVerificarInformacion({
                              id: asociado_id,
                              tipo_informacion:
                                'informacion_verificada_contactos',
                              valor: 'S',
                              verificar: true,
                            }),
                          );
...
export default AsociadoContacto;
